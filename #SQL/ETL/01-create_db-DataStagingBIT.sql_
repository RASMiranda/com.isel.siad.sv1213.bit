...
(
	...
	rua  NVARCHAR(100) NOT NULL, --CodigoPorala.arteria_titulo 
	numeroDaPorta NVARCHAR(10) NOT NULL,  --source: Morada.numPorta
	nomeLocalidade NVARCHAR(100) NOT NULL, --CodigoPostal.Nome_localidade
	codigoPostal INT NOT NULL,	 --CodigoPostal.
	extensaoCodigoPostal INT,  -- CodigoPostal.
	designacaoPostal NVARCHAR(100) NOT NULL, --CodigoPortal.
	freguesia NVARCHAR(50) NOT NULL,  -- source: freguesia, a partir de codigoPostal
	concelho  NVARCHAR(50) NOT NULL,  -- source: concelho, a partir de freguesia
	distrito NVARCHAR(50) NOT NULL     --source: distrito, a partir de concelho
);
/* carregamento: 
...
(
	...
	tipo  NVARCHAR(50) NOT NULL	 --TipoServico.tipo
);
/* carregamento:
...
(
	keycol INT PRIMARY KEY IDENTITY,
	oltp_id INT UNIQUE NOT NULL,
	nome  NVARCHAR(50) NOT NULL,  --Loja.nome
	localizacao  NVARCHAR(50) NOT NULL	 --Loja.localizacao
);
/*
...
(
	keycol INT PRIMARY KEY IDENTITY,
	oltp_id INT UNIQUE NOT NULL,
	designacao   NVARCHAR(100) NOT NULL, --Pessoa.designacao
	nomeContacto NVARCHAR(50) NOT NULL,  --Pessoa.
	sobrenomeContacto  NVARCHAR(50) NOT NULL, --Pessoa.
	singular  CHAR(1) NOT NULL,  --Pessoa.
	cPostal   NVARCHAR(4) NOT NULL,	  --Cliente.
    activo    CHAR(1) NOT NULL  --Cliente.
    --InfoDemografica RM
    ,BirthDate DATETIME NULL
    ,MaritalStatus NVARCHAR(150) NULL
    ,YearlyIncome NVARCHAR(150) NULL
    ,Gender NVARCHAR(150) NULL
    ,TotalChildren INT NULL
    ,NumberChildrenAtHome INT NULL
    ,Education NVARCHAR(150) NULL
    ,Occupation NVARCHAR(150) NULL
    ,HomeOwnerFlag NVARCHAR(150) NULL
...
(
	keycol INT PRIMARY KEY IDENTITY,
	oltp_id INT UNIQUE NOT NULL,
	funcao   NVARCHAR(50) NOT NULL, -- Funcao.nome
	-- salarioBase DECIMAL(8,2) NOT NULL, -- so devera ter interesse para a parte Financeira
	nome  NVARCHAR(50) NOT NULL, --Pessoa.
	sobrenome  NVARCHAR(50) NOT NULL, -- Pessoa.
	activo  CHAR(1) NOT NULL, --Funcionario.
	lojaNome  NVARCHAR(50) NOT NULL,  --Loja.nome
	localizacao  NVARCHAR(50) NOT NULL,	 --Loja.localizacao
	chefeNome NVARCHAR(50), --Funcionario.Nome relacao funcionarioId = reporta
	chefeSobrenome  NVARCHAR(50),
	chefeFuncao   NVARCHAR(50),	 
	chefe_id INT
);
/* Carregamento:
...
(
	...
	descricaoMes NVARCHAR(15) NOT NULL,
	diaSemana TINYINT NOT NULL,
	descricaoDiaSemana NVARCHAR(15) NOT NULL,
...
(
	...
	hora24 NVARCHAR(5) NOT NULL,
	hora12 NVARCHAR(8) NOT NULL
);
...
(
	...
	tipoPagamento NVARCHAR(50),-- Pagamento.Valor usando Entrega.servicoid = servico.servicoid  and entrega.entregaid= tipo.entregaid
